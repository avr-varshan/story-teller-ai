...
function StoryWriter() {
  ...
  async function runScript() {
    ...
    const response = await fetch('/api/run-script', {
      ...
      body: JSON.stringify({ story, pages, path: storiesPath, model: 'gpt-3.5-turbo' }), // Change 'gpt-4o' to 'gpt-3.5-turbo'
    //   body: JSON.stringify({ story, pages, path: storiesPath, model: 'gpt-4o' }), // Use 'gpt-4' or 'gpt-3.5-turbo'
    });
  ...
  async function handleStream(reader: ReadableStreamDefaultReader<Uint8Array>, decoder: TextDecoder) {
    ...
    while (true) {
      ...
      // Split chunk into events by splitting it by the event: keyword
    ...
    <div className="flex flex-col container">
      ...
      rounded-md p-10 space-y-2">
        <Textarea
          ...
          placeholder="Write a story about a human and a robot who became friends...."
        />
